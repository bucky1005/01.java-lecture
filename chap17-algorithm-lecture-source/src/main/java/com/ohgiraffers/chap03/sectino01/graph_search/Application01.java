...
/* 필기. 깊이 우선 탐색(Dept-First Search, DFS)
...
public class Application01 {
    ...
    static boolean[] visit;         // DFS의 방문 배열
    static int[][] map;
    ...
    public static Integer solution(String input) throws IOException {
        ...
        /* 설명. 노드의 간선에 대한 정보가 담길 map을 작성(node의 개수에 기반한 int형 2차원 배열) */
        map = new int[node + 1][node + 1];      // node의 번호와 인덱스 위치를 일치시키기 위해서 크기를 1 증가(0번인 데스는
...
//                map[b][a] = 1;
            ...
            /* 설명. dfs 그래프 탐색 기법으로 1번 노드부터 1번 노드와 관련된 모든 노드들을 카운팅하는 메세지 호출 */
            dfs(1);
        }
        return count;
    }
