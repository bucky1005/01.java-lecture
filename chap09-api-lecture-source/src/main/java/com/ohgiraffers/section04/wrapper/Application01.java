...
//        intValue.toString;        // 에러발생
        ...
        /* 설명. Wrapper 클래스값 비교 */
        /* 설명. Wrapper 클래스들로 리터럴(literal) 값으로 오토박싱하면 결국 동일한 객체 하나만 관리된다. */
    ...
    public static void anythingMethod(Object obj){  // 10 -> Integer(오토박싱) -> Object(다형성, 오토업캐스팅)
