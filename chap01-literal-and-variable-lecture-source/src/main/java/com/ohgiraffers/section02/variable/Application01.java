...
public class Application01 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("num = " + num);         // soutv : 내가 만든 변수에 대한 출력문 자동 작성
        ...
        /* 필기.
            ...
            2. 한 번 저장해둔 값을 재사용 하기 위한 목적(변수를 이용하여 코드를 작성하면, 값을 변경할 때도 보다 간편하게 변경할 수 있음)
        ...
        /* 설명. 위 코드에서 공통적으로 사용된 100이라고 하는 값을 변수에 넣고 변수를 호출하여 코드를 계산해보자.*/
        int point = 200;
        ...
        sum = sum + 10;                          // 기존에 0이 담겨있던 변수에 10이 덮어씀(변수는 하나의 리터럴만 저장 가능)
