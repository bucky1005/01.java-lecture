...
public class Application {
    public static void main(String[] args) {  //arg... srg
        System.out.println("");
        ...
        System.out.println("1. 기본자료형을 매개변수로 전달 받는 메소드 호출");
        int num = 20;
        ...
        System.out.println("2. 기본자료형 배열을 매개변수로 전달받는 메소드 호출");
        ...
        System.out.println("3. 클래스 자료형을 매개변수로 전달 받는 메소드 호출");
...
//        r1.calRound();
        ...
        /* 목차 4. 아직 클래스배열(객체 배열)은 배우지 않았으므로 건너 뜀 */
        System.out.println("4. 클래스배열(객체 배열)은 배우지 않았으므로 건너 뜀");
        System.out.println();

        /* 목차 5. 가변인자를 매개변수로 전달받은 호출 */
        System.out.println("5. 가변인자를 매개변수로 전달받은 호출");
        pt.testVariableLengthArrayParameter();
        pt.testVariableLengthArrayParameter("홍길동");
        pt.testVariableLengthArrayParameter("유관순", "볼링");
        pt.testVariableLengthArrayParameter(new String[]{"강감찬", "낚시", "독서"});  //비권장
