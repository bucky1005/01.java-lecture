...
public class Application {
    public static void main(String[] args) {
        ...
        EagerSingleton eager1 = EagerSingleton.getInstance();       // singleton은 new를 사용하여 새로 객체를 생성하지 않고,
                                                                    // 바로 사용할 수 있다.
        EagerSingleton eager2 = EagerSingleton.getInstance();
        System.out.println("eager1의 주소: " + eager1.hashCode());
        System.out.println("eager2의 주소: " + eager2.hashCode());    // eager1, eager2는 서로 다른 객체 같지만 주소값을 출력해보면
                                                                     // 둘은 하나의 인스턴스를 가지고 있다는 것을 확인할 수 았다.
        ...
        /* 필기.
            ...
            첫 번째 요청에 대한 속도가 두 번째 요청에 대한 속도보다는 느리다는 특징을 가지고 있다.
         */
    }
}
