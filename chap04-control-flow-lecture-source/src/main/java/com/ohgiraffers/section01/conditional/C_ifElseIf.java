...
public class C_ifElseIf {
    ...
    public void testSimpleIfElseIfStatement() {
        ...
        System.out.println("연못에서 산신령이 나타나 금도끼, 은도끼, 쇠도끼를 들고 나왔다.");
        System.out.println("나무꾼에게 셋 중 어떤 도끼가 나무꾼의 도끼인지 물어모았다.");
        ...
        if (answer == 1) {
            ...
            System.out.println("욕심이 과하지는 않지만 그래도 넌 거짓말을 하고있구나! 어서 썩 꺼지거라!\n");
        } else {
            System.out.println("오호~ 정직하구나~ 여기 있는 금도끼, 은도끼, 쇠도끼를 다 가져가거라~!\n");
        }

        System.out.println("그렇게 산신령은 다시 연못 속으로 홀연히 사라졌다....");
    }
    ...
    public void testNestedIfElseIfStatement() {
        ...
        if(score <= 100 && score >= 0){
            ...
            System.out.println("입력 가능한 점수 범위가 아닙니다.");
        }

        /* 필기. 중복이되는 부분은 공통점을 찾아 효율적으로 나타낼 수 있는 방법을 찾아보자 */
        if (score <= 100 && score >= 0) {
            if (score >= 90) {
                if (score >= 95) {
            ...
            System.out.println("잘못된 범위의 점수가 입력되었음.");
        }
