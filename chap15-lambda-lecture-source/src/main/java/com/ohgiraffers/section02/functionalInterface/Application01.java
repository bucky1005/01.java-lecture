...
public class Application01 {
    public static void main(String[] args) {
        ...
        /* 필기.
            JDK 8 에서 빈번하게 사용되는 함수적 인터페이스를 표준 API로 제공하고 있다.
            ...
            4. operator: Function과 같이 applyXXX(0 메소드를 지니고 있다. 차이점은 매개변수 및 반환형의 타입이 통일되어 있다.
        ...
        // 매개변수가 2개 이상인 경우 소괄호로 묶기
//        Consumer<String> consumer = (str) -> System.out.println(str + "이(가) 입력됨");
        // 메소드에 반환형(리턴값)이 있는경우 중괄호와 함께 작성
//        Consumer<String> consumer = (str) -> { return System.out.println(str + "이(가) 입력됨" ); };
