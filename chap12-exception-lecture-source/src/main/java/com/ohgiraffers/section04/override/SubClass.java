...
public class SubClass extends SuperClass{
    ...
    /* 필기.
        메소드를 오버라이딩 하기 위해서는 브부모 메소드에서 발생하는 예외와 같거나 하위타입은 가능하다.
        아예 예외가 발생하지 않더라도 오버라이딩에는 문제가 없다.
        반면, 부모의 메소드보다 더 상위 타입의 예외를 발생 시키는 오버라이딩 메소드는 커ㅁ파일 에러가 바랫ㅇ한ㄷ.
...
//    }
    ...
    // FileNotFoundException은 IOException의 자식 클래스이므로 O
//    @Override
...
//    }
    ...
    // Exception은 IOException의 부모클래스이므로 X
